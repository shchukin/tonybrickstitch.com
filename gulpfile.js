...
gulp.task('patterns', function () {
    return gulp.src('src/patterns/**/*', {encoding: false})
        .pipe(plumber())
        .pipe(gulp.dest('docs/patterns/'))
        ;
});
...
gulp.task('default', function (fn) {
    run('clean', 'manifest', 'favicon', 'patterns', 'content', 'images', 'markups', 'layouts', 'vendors', 'scripts', 'symbols', 'styles', 'lint', fn);
});
